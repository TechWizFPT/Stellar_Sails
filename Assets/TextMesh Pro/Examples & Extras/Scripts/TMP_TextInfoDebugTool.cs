...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the info object's textInfo
            m_TextInfo = m_TextComponent.textInfo;

            // Update partNameUI Statistics
            ...
            // Draw Quad around the bounds of the info
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the info.
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the info.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the info.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link info
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the info.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the info object.
        /// </summary>
        void DrawBounds()
        {
